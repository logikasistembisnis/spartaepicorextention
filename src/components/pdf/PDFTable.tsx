    ...
    return (
        <View style={styles.table} wrap>
            ...
            <View style={styles.rowHeader} fixed>
                ...
                <Text style={[styles.colPart, styles.bold, styles.center]}>Part No</Text>
                <Text style={[styles.colQty, styles.bold, styles.left]}>Qty</Text>
                <Text style={[styles.colUom, styles.bold, styles.left]}>Satuan</Text>
                <Text style={[styles.colQtyStd, styles.bold, styles.left]}>Qty Std</Text>
                <Text style={[styles.colUom, styles.bold, styles.left]}>Satuan</Text>
                <Text style={[styles.colRemark, styles.bold, styles.center]}>Keterangan</Text>
            </View>
            ...
            {sortedLines.map((l, i) => (
                <View key={i} style={styles.row}>
                    ...
                    <Text style={[styles.colItem, styles.left]}>{l.partDesc}</Text>
                    <Text style={[styles.colPart, styles.left]}>{l.partNum}</Text>
                    <Text style={[styles.colQty, styles.right]}>{formatQty(l.qty)}</Text>
                    <Text style={[styles.colUom, styles.center]}>{l.uom}</Text>
                    <Text style={[styles.colQtyStd, styles.right]}>{formatStd(l.qty)}</Text>
                    <Text style={[styles.colUom, styles.center]}>{l.uom}</Text>
                    <Text style={[styles.colRemark, styles.center]}>{l.comment}</Text>
                </View>
            ))}
            ...
            <View style={styles.totalRow}>
                ...
                <Text style={[styles.colPart, styles.center]}>Total</Text>
                <Text style={[styles.colQty, styles.right]}>{formatQty(totalQty)}</Text>
                <Text style={styles.colUom}></Text>
                <Text style={styles.colQtyStd}></Text>
                <Text style={styles.colUom}></Text>
...
const styles = StyleSheet.create({
    ...
    colItem: {
        width: '22%', // Nama Barang lebar
        fontSize: 9,
        paddingRight: 8
    },
    colPart: {
        width: '22%', // Part No lumayan lebar
        fontSize: 9,
        paddingRight: 8
    },
    colQty: {
